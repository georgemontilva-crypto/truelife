        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div className="order-1 lg:order-2">
            ...
            <p className="text-gray-500 leading-relaxed mb-8 text-base">
              Premium THCa, THCp, D8, HHC, HHCp, CBD, and CBG – available in flower, pre-rolls, trim, gummies, carts, and disposables.
            </p>
            <div className="grid grid-cols-2 gap-3 mb-8">
              {[
                { icon: FlaskConical, title: "Flower and Pre-rolls", desc: "Carefully selected and prepared for an optimal experience." },
                { icon: Leaf,         title: "Trim", desc: "Ideal for those who want to make the most of the plant in extractions or customized preparations." },
                { icon: Award,        title: "Gummies", desc: "Edibles infused with precise doses, perfect for discreet and long-lasting consumption." },
                { icon: Shield,       title: "Cartridges (Carts) and Disposables", desc: "Convenient, ready-to-use vaping solutions that combine ease of use with potent effects." },
